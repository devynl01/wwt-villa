...
fbi -T 1 -d /dev/fb0 -noverbose -a -t $INTERVAL -u `find $PHOTODIR -iname "*.jpg" -o -iname "*.png" | sort` # finding all the pictures and then putting them into fbi for slideshow
